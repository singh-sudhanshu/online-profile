insert into user (id, active, email, firstname, lastname, password, mobile, houseno, street, city, pincode, state, country) values (1, 1, 'admin@anyemail.com', 'Admin', ' ', '$2a$10$d7Z/CJSv0JQORx4ubVAChuS1QkPUGAKwSEU3LkycfijU5mvZ7Bwx.','123','4125','park street','perth','1000','westaus','Australia');
